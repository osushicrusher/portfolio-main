...
<body> 
    ...
    <main>
        ...
        <section class="contact">
            ...
            <form class="contact__form-box effect-fade" method="POST" action="contact.php">
                ...
                <p class="contact__form">                            
                    ...
                    <input type="text" name="subject" id="subject" class="contact__input contact__input--text" placeholder="件名" value="" required>
                </p>
                <p class="contact__form">
                    <label for="message">お問い合わせ内容</label><br>
                    <textarea name="message" class="contact__input contact__input--message" id="message" value="" required></textarea>
                </p>                            
